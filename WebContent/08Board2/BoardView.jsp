...
검색 후 파라미터 처리를 위한 추가 부분
	...
	눌렀을 때 검색이 유지되도록 처리하기 위한 코드ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ삽입
*/
String queryStr = "";
...
//3페이지에서 상세보기했다면 리스트로 돌아 갈 때 도 3페이지로 가야한다.
...
<div class="col-9 pt-3">
	...
	저장되므로 HTMl페이지에서 출력 할 때는 <br/>태그로 문자열을
	변경해야 한다
...
게시물의 일련번호(PK)가 파라미터로 전달 되어야 한다. -->
