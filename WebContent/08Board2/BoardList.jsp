...
String queryStr = ""; //검색시 페이지번호로 쿼리스트링을 넘거주기 위한 용도
		...
		else
		{
			...
			*/
			for(BbsDTO dto : bbs){
				...
				현재페이지1
					첫번째게시물 : 99 - (((1-1)*10)+0) = 99
					두번째게시물 : 99 - (((1-1)*10)+1) = 98
				현재페이지2
					첫번째게시물 : 99 - (((2-1)*10)+0) = 97
					첫번째게시물 : 99 - (((2-1)*10)+1) = 96
				*/
		%>
