...
<body>
	...
	<ul>
		...
		<li>
			<a href="SimpleMVC?type=greeting&id=blosseden&pw=1234">
			SimpleMVC?type=greeting&id=blosseden&pw=1234
			</a>
		</li>
		<li>
	...
	<!-- 
		...
		설정하는 것이 좋다. 이미지의 경로, JS, CSS 파일을 링크 했을 때
		경로가 깨지는 경우가 발생 할 수 있기 때문이다.
		아래 이미지는 요청명이 
			/13Servlet/SimpleMVC 일 때는 정상적으로 출력되나
			//SimpleMVC 일 때는 이미지가 출력 되지 않는다.
	 -->
	<h3>이미지와 요청명</h3>
	<img src="../images/Screenshot_20200511-120553_QuickPic.jpg" />
</body>
</html>