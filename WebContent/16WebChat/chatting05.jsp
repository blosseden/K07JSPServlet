...
var chat_id, chat_room; //채팅아이디, 채팅방 전역 변수 선언
var webSocket;
window.onload = function(){		
	...
	webSocket = new WebSocket('ws://localhost:8282/K07JSPSevlet/ChatServer02');
...
function wsMessage(event) {
    ...
    if (content == "") {
    	...
    	//같은 룸에 있는 클라이언트에게만 메세지를 디스플레이 한다.
    	if(chat_room==room){
    	//내용에 / 가 있다면 귓속말이므로...
    	if (content.match("/")) {
...
function sendMessage() {	
	...
	//메세지 입력 후 전송 할 때 "채팅방+아이디+메세지" 형태로 조립해서 보낸다.
