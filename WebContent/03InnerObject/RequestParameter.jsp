...
<body>
	...
	/*
	전송방식 ge/post에 상관없이 getParameter("파라미터명") 메소드로
	...
	*/
	...
	if( !(name==null || name.equals("")) ){
		...
		아래와 같이 사용 할 수 있다. 또는 문자열을 연결하여 사용할 수 도
		있다.
		*/
		out.println("<script>");
		out.println("	alert('이름을 입력하세여');");
	...
	/*
	radio는 폼값을 아래 2가지 방법을 모두 사용 할 수 있다
	...
	*/
	...
	웹브라우저에 출력 할 때는 특수기호를 <br>태그로 변환 후 출력해야한다.
	*/
	String self_intro =
...
<%
/*
getParameterNames() : 폼갓ㅂ이 이름을 한꺼번에 받을 때 사용하는
...
*/
	...
	while(names.hasMoreElements()){
		...
		if(paramName.equals("sex") ||
			...
			out.println("파라미터명을 getPrameterValues()로"
					+" 얻어서 값 출력함 <br/>");
		}
		else{
			System.out.println("getPrameter()로 읽기");
