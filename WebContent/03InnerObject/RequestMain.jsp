...
<body>
	...
	3. <form method="get" 을 사용하는 방법
	 -->
	<h3>Get방식 전송</h3>
	<a href="Requestintro.jsp?paramNum=123&paramEng=Hello&paramHan=안농">
			Get빙식</a>
			
	<h3>Post방식 전송</h3>
	<form action="Requestintro.jp" method="post">
	...
	<a href="RequestParameter.jsp?name=<%=encodeName%>
			&id=hong&sex=man&favoorite=&self_intro=">Get방식</a>
	<br />
	<br />	
	<script>
	...
	<form method="post" name="regFrm" action="RequestParameter.jsp"
		...
		관심사항 :
			...
			<input type="checkbox" name="favorite"
				value="ecomomic" checked="checked" />경제
			<input type="checkbox" name="favorite"
			...
			rows="10">나는 그냥 그러려니 살았어</textarea>
			<br/>
				<input type="submit" value="POST방식" />
			</form>
