...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    application영역에 속성 저장하기
     - 어플리케이션 역역에 저장된 속성은 모든 JSP(Servlet) 페이지에서
     	공유된다.
    ...
    */
    ...
    //DTO객체 생성
    MemberDTO first = new MemberDTO("kim", "1111", "김기명",mySqlDate);
    MemberDTO second= new MemberDTO("Park", "2222","박기지",null);
    MemberDTO third = new MemberDTO("Lee", "3333", "이태랑",null);
...
<body>
	...
	<!-- 외부파일 인클루드 : include 지시어를 통해 페이지를 삽입하면
			파일의 내용이 그대로 포함된 후 ㅍ=컴파일 되므로 하나의 페이지라
