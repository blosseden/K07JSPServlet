...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    /*
    모든영역(페이지, 리퀘스트, 세션, 어플리케이션)에는 모든 타입은 객체를
    저장 할 수 있다. Object타입으로 자동 형변환 되어 저장되고, 사용시에는
    각 객체로 형변환 후 사용하면 된다. 차후 EL(표현언어) 을 사용하면 형변ㅘㄴ 없이
    사용 할 수 있다.
    ...
    */
    ...
    pageContext.setAttribute("pageMember2", 
    			new MemberDTO("잇힝" , "1234", "성강사", null));
    %>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<%
	/*
	pag영역에 저장 될 때 Object타입으로 자동 형변환되어 저장되므로
	...
	*/
	...
	<%--
		...
		포함된 후 컴파일되므로 include 지시어를 사용 하는 경우
